...
# Ввод последовательности чисел с разделением по пробелам, переводом в список и проверкой правильности введенных данных
inp_error = True
...
match NumbCheck(numb, seq): # Вывод результата
    ...
    case _:
        ...
        print(f'Введенное число {numb} больше элемента {pos - 1} и меньше или равно элементу {pos} в последовательности чисел {seq}.')
